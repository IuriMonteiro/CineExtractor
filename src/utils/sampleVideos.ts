...
export const SAMPLE_VIDEOS: SampleVideo[] = [
  {
    id: "tears-of-steel",
    title: "Sci-Fi Cyberpunk Scene (Tears of Steel)",
    duration: "0:14",
    genre: "Sci-Fi / Action",
    description: "High-contrast cinematic cuts between characters, futuristic tech, drone shots, and neon lighting.",
    url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4",
    thumbnail: "https://images.unsplash.com/photo-1578632767115-351597cf2477?w=400&q=80",
  },
  {
    id: "big-buck-bunny",
    title: "Animated Feature Sequence",
    duration: "0:18",
    genre: "Animation / Adventure",
    description: "Vibrant multi-scene animation with bright high-key lighting, rapid camera pans, and expressive character close-ups.",
    url: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4",
    thumbnail: "https://images.unsplash.com/photo-1534447677768-be436bb09401?w=400&q=80",
  },
  {
    id: "for-bigger-blazes",
    title: "Cinematic Action & Nature Montage",
    duration: "0:15",
    genre: "Drama / Documentary",
    description: "Dynamic outdoor cinematography with golden hour lighting, extreme wide establishing shots, and dramatic silhouettes.",
